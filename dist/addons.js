...
export async function addDefaultAddons(_addonsList, _excludeList = [], _paths) {
    // TODO - enable addons
    /**
 ...
 */
function getAddonPath(addonName, paths) {
 ...
 */
export async function maybeDownloadAddons(addons, addonsList = [], paths) {
